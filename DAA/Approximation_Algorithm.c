Aim :   To design and implement an approximation algorithm to the Vertex Cover Problem that efficiently finds a near-optimal set of vertices covering all edges in a graph.
